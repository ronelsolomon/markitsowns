#!/usr/bin/env python3
"""
Batch PDF to LLM Processor

Process multiple PDF files in a directory using MarkItDown and LLM.
"""
...
from pdf_to_llm import PDFToLLMProcessor

class BatchPDFProcessor:
    def __init__(self, model="gpt-4-turbo-preview", max_workers=3):
        """Initialize batch processor."""
        self.processor = PDFToLLMProcessor(model=model)
    ...
    def process_single_pdf(self, pdf_path, output_dir, prompt=None):
        ...
        try:
            ...
            output_filename = pdf_path.stem + "_processed.txt"
...
def main():
    parser = argparse.ArgumentParser(description='Batch process PDF files with LLM')
